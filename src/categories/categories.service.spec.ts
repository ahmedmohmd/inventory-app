...
// 			await categoriesService.findCategoryById(id);
// 		} catch (error) {
...
// 		const targetCategory = await categoriesService.findCategoryById(id);
...
// 		const createdCategory = await categoriesService.insertCategory(category);
...
// 		const createdCategory = await categoriesService.updateCategory(
// 			id,
// 			category
// 		);
